...
import com.vlonjatg.android.apptourlibrary.PagerAdapter;
 ...
 */
public abstract class CustomAppTour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.custom_app_tour);

        introViewPager = (ViewPager) findViewById(com.vlonjatg.android.apptourlibrary.R.id.introViewPager);
        controlsRelativeLayout = (RelativeLayout) findViewById(com.vlonjatg.android.apptourlibrary.R.id.controlsRelativeLayout);
        skipIntroButton = (Button) findViewById(com.vlonjatg.android.apptourlibrary.R.id.skipIntroButton);
        nextSlideImageButton = (ImageButton) findViewById(com.vlonjatg.android.apptourlibrary.R.id.nextSlideImageButton);
    ...
    public void setNextButtonColorToWhite() {
        nextSlideImageButton.setImageResource(com.vlonjatg.android.apptourlibrary.R.drawable.ic_next_white_24dp);
    }
    ...
    public void setNextButtonColorToBlack() {
        nextSlideImageButton.setImageResource(com.vlonjatg.android.apptourlibrary.R.drawable.ic_next_black_24dp);
    }
